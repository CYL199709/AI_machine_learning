...
characters = strcat(characters, recognise(hanzi_theta1, hanzi_theta2, temp_char, lib1,0));
...
for i = 2:7
    ...
    temp_char = temp_char(:)';
    characters = strcat(characters, recognise(Theta1, Theta2, temp_char, lib2,1));
